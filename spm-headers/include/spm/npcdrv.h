...
// exported from Yme's NPCTribeId enum off Ghidra; there may be some errors and uncertainties in unused/redundant/nonfunctional tribe IDs
enum NPCTribeId
{
    NPC_GOOMBA = 0,
    NPC_FLIP_GOOMBA = 1,
